...
//    @Max(15)
    ...
    public Section(String sectionName, int capacity, String roomNumber, int availableSeat, Status status, Course course, Faculty professor, List<Enrollment> enrollements) {
    ...
    public int hashCode() {
        ...
        hash = 59 * hash + this.availableSeat;
